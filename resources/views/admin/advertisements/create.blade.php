...
<div class="flex flex-col gap-8">
    <div class="flex flex-col gap-1">
        <h1 class="text-4xl font-black tracking-tight text-[#181811] dark:text-white">Add Advertisement</h1>
        <p class="text-base text-[#8c8b5f] dark:text-[#a1a18d]">Create a new advertisement for the marketplace.</p>
    </div>
